...
:white_check_mark: | Courses | Duration | Effort | Prerequisites | Discussion
:-- | :-- | :--: | :--: | :--: | :--: 
:arrow_right: | [Introduction to Computer Science and Programming using Python](coursepages/intro-cs/README.md) | 14 weeks | 6-10 hours/week | [high school algebra](https://ossu.dev/precollege-math) | [chat](https://discord.gg/jvchSm9)
